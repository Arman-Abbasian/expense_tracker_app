...
import FormReduxToolkit from "./FormReduxToolkit";

const ShowTotalCostsReduxToolkit = () => {
    ...
    return ( 
        <div className="mb-10">
            <div>
                ...
                <FormReduxToolkit showForm={showForm}/>
            </div>
...
export default ShowTotalCostsReduxToolkit;